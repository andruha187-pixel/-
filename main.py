...
#   * same Polymarket books / same 3-second signal history
# ============================================================

VERSION = "9.0-paper-ab-gate64-safe-stop30"
...
DB_PATH = DATA_DIR / "gate64_safe_ab_stop30.db"
REPORT_DIR = DATA_DIR / "gate64_safe_ab_stop30_reports"
...
log = logging.getLogger("gate64-safe-ab-stop30")
    ...
    while True:
        ...
        try:
            for cid, market in list(markets.items()):
                ...
                # Refresh once, then both A and B see the same current books on this decision tick.
...
async def main():
    ...
    session = aiohttp.ClientSession(headers={
        "User-Agent": f"M03Gate64SafeABStop30/{VERSION}",
